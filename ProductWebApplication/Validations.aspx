<%@ Page Title="" Language="C#" MasterPageFile="~/Mainsheet.Master" AutoEventWireup="true" CodeBehind="Validations.aspx.cs" Inherits="ProductWebApplication.Validations" %>

<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" runat="server">
    
    <script>
        function customValidation(sender, args) {
            if ((args.Value == "Pavan") || (args.Value == "Pavana"))
                args.IsValid = true;
            else {
                args.IsValid = false;
                alert("Pavan or Pavana is expected");
            }
        }
    </script>
    <div class="container">
        ...
        <div>
            <p>
             Enter the Employee Name: 
                ...
                <asp:CustomValidator  ID="CustomValidator1" runat="server" ControlToValidate="txtName" ErrorMessage="Name should be either Pavan or Pavana" ForeColor="#FF3300" OnServerValidate="CustomValidator1_ServerValidate" ClientValidationFunction="customValidation"></asp:CustomValidator>
            </p>
             <p>
